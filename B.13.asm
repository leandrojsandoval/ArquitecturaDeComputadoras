* B.13 Escriba una rutina para el HC11 (llamada CONTCANT) que reciba en IX la dirección de
...
* el registro IX la cantidad de veces que aparece el valor informado en IY dentro del vector.
...
Vector		FDB		$1234,$90,$1234,$321,$1234,$1,$1234
		FDB		0
